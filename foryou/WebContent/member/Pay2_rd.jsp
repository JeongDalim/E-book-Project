...
<script type="text/javascript">
	...
	function cardsend() {
		...
		card.action="Member?cmd=RDMemberPayInsert";
		card.submit();
		alert("Payment information has been registered.");
		card.action="BookCart?cmd=rentDelete";
		card.submit();
	...
	function banksend() {
		...
		form.action="Member?cmd=RDMemberPayInsert";
		form.submit();
		alert("Payment information has been registered.");
	...
	<div id="1" style="display: none">
		<form name="card" method="post">
			<input type="hidden" name="pay" value="card"> <input
				...
				type="hidden" name="idxs" value="${idxs }"> <input
				type="hidden" name="bookCart" value="${bookCart }">
			<table class="Login_tab_P">
				<tr>
