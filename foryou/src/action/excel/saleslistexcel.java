...
public class saleslistexcel {
	public void testexcel(List<SalesVO> list,int year,int month) {		
		// �뿊���뙆�씪 媛앹껜 �깮�꽦
		...
		// ���옣�븷 �뙆�씪 媛앹껜 �깮�꽦
		File file = new File("C:\\excel\\saleslistexcel.xls");
		...
		try {
			...
			for (int i = 0; i < list.size(); i++) {
				...
				label = new Label(0, (i + 1), vo.getCompany());
				sheet.addCell(label);
